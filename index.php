...
_Hasync.push(['Histats.start', '1,5018945,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5018945&101" alt="free website hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->
  	<!-- 
    	Gloss Template
            ...
            <div id="top-menu">
              <div class="collapse navbar-collapse main_menu" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a class="show-1 templatemo_page2" href="#"><span class="fa fa-picture-o"></span>GALLERY</a></li>
                  <li><a class="show-1 templatemo_page3" href="#"><span class="fa fa-users"></span>ABOUT</a></li>
                  <li><a class="show-1 templatemo_page4" href="#"><span class="fa fa-envelope"></span>CONTACT</a></li>
                </ul>
              </div>
            </div>
            <!-- /.navbar-collapse --> 
  	...
  	<div class="container">
        ...
        <div class="templatemo_homewrapper shadow">
            ...
            <div class="col-md-6">
                ...
                <p>Gloss is free responsive mobile template for everyone. Please tell your friends about <span class="bluetext">template</span><span class="greentext">mo</span>.com website. This layout is based on Bootstrap v3.1.1 framework. Credits go to <a rel="nofollow" href="http://www.smashingmagazine.com/2012/11/20/art-professions-icons-png/">Art Professions</a> Icon and <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for images used in this template.</p>
                ...
                <p>Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 templatemo_box_last gradient">
            	...
            	<img src="images/templatemo_icon_search.png" alt="templatemo search">
                 ...
                 <div class="templatemo_home_midtext">Duis at lectus non neque ultrices porttitor. Cras ipsum sem, iaculis ut, sodales ut, accumsan lacinia, nunc. </div>
                 <a href="#"><div class="templatemo_readmore gradient">READ MORE</div></a>
                 </div>
                 </div>
            </div>
